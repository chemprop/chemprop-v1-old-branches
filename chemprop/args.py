...
Metric = Literal['auc', 'prc-auc', 'rmse', 'mae', 'mse', 'r2', 'accuracy', 'cross_entropy', 'binary_cross_entropy', 'sid', 'wasserstein', 'f1', 'mcc', 'bounded_rmse', 'bounded_mae', 'bounded_mse', 'auc-multiclass-strict', 'auc-multiclass-relaxed', 'prc-auc-multiclass-strict', 'prc-auc-multiclass-relaxed']
    ...
    def process_args(self) -> None:
        ...
        for metric in self.metrics:
            if not any([(self.dataset_type == 'classification' and metric in ['auc', 'prc-auc', 'accuracy', 'binary_cross_entropy', 'f1', 'mcc']), 
                    ...
                    (self.dataset_type == 'multiclass' and metric in ['cross_entropy', 'accuracy', 'f1', 'mcc', 'auc-multiclass-strict', 'auc-multiclass-relaxed', 'prc-auc-multiclass-strict', 'prc-auc-multiclass-relaxed']),
